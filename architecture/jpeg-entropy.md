...
- **steganography/embed.rs**: `apply_dct_stego_bytes_from_plan` and its legacy `apply_dct_stego_bytes` (legacy context path) use decoder/encoder for JPEG fast path
