...
- Plans are sequential — the next new plan takes the lowest unused number (currently 098+; highest so far is 097). Never renumber or edit historical plans except their `-status.md`
