...
- Plans are sequential — the next new plan takes the lowest unused number (currently 105+; highest so far is 104). Never renumber or edit historical plans except their `-status.md`
