...
|---|---|---|---|---|
| M001 Python foundation | ready | `implementation/language-bindings/001-python-binding-foundation.md` | pending | none |
| M002 Python packaging | blocked | `implementation/language-bindings/002-python-packaging-qualification.md` | pending | M001 closure |
