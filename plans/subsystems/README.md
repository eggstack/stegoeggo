...
Roadmaps translate `plans/000`–`002` into coherent, dependency-aware
workstreams. They are not coding-agent checklists; mechanics belong in
`plans/implementation/`.

Each roadmap has 12 sections (purpose/boundary, classification, non-goals,
...
- `stego-carrier-roadmap.md` (closed)
