...
`stegoeggo` is a Rust library and CLI for protecting images from unauthorized AI use through steganographic watermarking and metadata injection for legal deterrence.
